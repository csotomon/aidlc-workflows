...
describe("classifyTerminalCommand() — read-only flags (match anywhere)", () => {
  ...
  test("--doctor carries allowlisted export args (--export, --output <dir>) as extraArgs", () => {
    ...
    // flags into extraArgs. A bare --doctor has none (no spurious key).
