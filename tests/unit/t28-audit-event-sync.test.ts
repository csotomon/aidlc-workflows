...
// +RECOMPOSED (adaptive composer) took it to 70; +REVIEWER_SCOPE_BLOCKED
// (the reviewer-scope PreToolUse hook) took it to 71; +PLUGIN_SELECTION_CHANGED
// (select-plugins set-mode) took it to 72; reviewer-enforcement RFC Track 1:
// +REVIEW_REQUESTED +REVIEW_COMPLETED takes it to 74.
...
describe("t28 audit event-type sync (migrated from t28-audit-event-sync.sh, plan 7)", () => {
  ...
  // #369 removed TEST_RUN_MODE_ENABLED -> 68; HUMAN_TURN took it to 69; the
  // adaptive composer added RECOMPOSED -> 70; REVIEWER_SCOPE_BLOCKED took it to
  // 71; PLUGIN_SELECTION_CHANGED took it to 72; Track 1 added
  // REVIEW_REQUESTED/REVIEW_COMPLETED -> 74.)
